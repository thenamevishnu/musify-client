...
import { setAdminToken } from "../../Utils/localdb"
...
const AdminLogin = () => {
    ...
    const handleForm = async (event) => {
        ...
        if (response.token) {
            ...
            const {_id, name, username, email, picture} = getUserFromJwt(response.token)
            ...
            setClicked(false)
            return navigate(`/admin/${import.meta.env.VITE_ADMIN_HOME}`)
        }
        setClicked(false)
