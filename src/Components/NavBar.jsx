                        ...
                        username && <Fragment>
                            ...
                            <section className={`fixed overflow-y-scroll pb-4 top-0 h-[100vh] bg-black bg-opacity-90 w-full sm:w-96 text-black transition-all duration-150 ease-linear ${isMenu ? `left-0` : `left-[-100vw] sm:left-[-24rem]`} px-2`}>
                                ...
                                <div className='px-4 mt-10 flex flex-col gap-3'>
                                    <div className='p-2 bg-white text-black px-5 rounded-xl cursor-pointer hover:bg-secondary hover:text-white transition-all duration-100 ease-linear'><i className='fa fa-user mr-3' />Update Profile</div>
